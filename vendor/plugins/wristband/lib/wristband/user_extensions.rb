  ...
  module UserExtensions
    ...
    module InstanceMethods
      ...
      def encrypt_password
        initialize_salt if self.password_salt.blank?
      ...
      def password_match?(string)
        if self.class.wristband[:plain_text_password]
          ...
          logger.info [self.send(self.class.wristband[:password_column]), Wristband::Support.encrypt_with_salt(string, self.password_salt)].to_yaml
