module Wristband
  module ApplicationExtensions
    ...
    module InstanceMethods
      ...
      def create_logging_cookie
        cookies[:user_id] = { :value => self.session_user.to_param, :expires => 2.weeks.from_now.utc }
      end
  
      def destroy_logging_cookie
